...
namespace GLVM::core
{
    ...
    void WindowXOpengl::CursorLock(int _x_position, int _y_position, int* _x_offset, int* _y_offset)
    {
    ...
    Window WindowXOpengl::GetWindow() { return Win_; }
    Display* WindowXOpengl::GetDisplay() { return pDisp_; }
